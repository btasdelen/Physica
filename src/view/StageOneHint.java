...
import controller.StageOneHintController;

@SuppressWarnings("serial")
public class StageOneHint extends JPanel {

	/**
	 * author muhammet
	 */
	
	private StageOneHintController sohc = new StageOneHintController(this);
	...
	public StageOneHint() {
		...
		ImageIcon img = new ImageIcon("backgrounds/stageonehint.jpg");
