...
import controller.StageHintsController;
...
public class StageHintsPanel extends JPanel {
	...
	public StageHintsPanel() {
		setLayout(null);
		
		ImageIcon img = new ImageIcon("backgrounds/stagehints.jpg");
		...
		btn1.addActionListener(new StageHintsController(this));
		
		btn2.addActionListener(new StageHintsController(this));

		btn3.addActionListener(new StageHintsController(this));

		btn4.addActionListener(new StageHintsController(this));

		btn5.addActionListener(new StageHintsController(this));

		btn6.addActionListener(new StageHintsController(this));

		btn7.addActionListener(new StageHintsController(this));

		btn8.addActionListener(new StageHintsController(this));

		btn9.addActionListener(new StageHintsController(this));

		btn10.addActionListener(new StageHintsController(this));
		
		btn11.addActionListener(new StageHintsController(this));
