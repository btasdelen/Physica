...
import controller.StageTwoHintController;

@SuppressWarnings("serial")
public class StageTwoHint extends JPanel {

	/**
	 * author muhammet
	 */
	
	private StageTwoHintController stc = new StageTwoHintController(this);
	...
	public StageTwoHint() {
		...
		ImageIcon img = new ImageIcon("backgrounds/stagetwohint.png");
