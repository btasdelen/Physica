...
import controller.StageFourHintController;

@SuppressWarnings("serial")
public class StageFourHint extends JPanel {

	/**
	 * author muhammet
	 */
	
	private StageFourHintController sfhc = new StageFourHintController(this);
	...
	public StageFourHint() {
		...
		ImageIcon img = new ImageIcon("backgrounds/stagefourhint.png");
